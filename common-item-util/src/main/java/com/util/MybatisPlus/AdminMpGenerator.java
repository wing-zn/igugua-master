...
public class AdminMpGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://192.168.11.55:3306/hall-marketing-ccb?serverTimezone=UTC");
        ...
        pc.setParent("com.mzydz.platform");
        pc.setEntity("entity.PO.agent");
