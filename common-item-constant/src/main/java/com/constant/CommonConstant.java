...
public class CommonConstant {
     ...
     * 其他币种的保留小数位
     */
    public static Integer DECIMAL_PLACE_TWO = 8;

    /**
     * 项目名
     */
    public static final String project = "HMCCCB";
     ...
     * 账号前缀字符串
     */
    public static String ACCOUNT_PREFIX_STR = "CCB";
    /**
     * 账号前缀数字
     */
    public static Integer ACCOUNT_PREFIX_NUM = 6688;
