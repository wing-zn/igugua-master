...
public class ResponseMsg {
     ...
     * 令牌与用户不匹配
     */
    public static String TOKEN_USER_ERR = "用户token错误";
    /**
     * 账户不可用
     */
     ...
     * 无效id
     */
    public static String ILLEGAL_PARAM_ID = "参数id非法";
    ...
    public static String DEAL_COIN_LITTER = "账户%s余额不足！";
    ...
    public static String ROLE_SELECT_ERROR = "该角色选择错误";

    public static String COMPANY_USER_DISABLE_SELECT_ROLE = "企业超级主用户不能更换角色";
    public static String COMPANY_USER_NO_EDIT_ROLE_NOT_MY = "不能编辑默认角色及非自己的角色";
    public static String COMPANY_USER_NO_DEL_ROLE_NOT_MY = "不能删除默认角色及非自己的角色";
    public static String COMPANY_USER_NO_AUTH_ROLE_NOT_MY = "不能对默认角色及非自己的角色授权";
    ...
    /***********************后台会员管理**************************************/
    public static String USER_NO_DEL_SELF = "用户不能删除自己！";
    public static String COMPANY_USER_NO_DEL = "企业用户不允许删除！";
    ...
    /*********************** 短信发送 ********************************/
    public static String SMS_NO_TIME_MINUTE_1 = "请等待60s后再发送！";
    ...
    //管理员只能删除系统的模板，
    public static String PROGRAM_TEMPLATE_IS_SYSTEM = "您不能对该模板进行删除操作！";
    public static String PROGRAM_TEMPLATE_TYPE_NAME_EXIST = "该节目类别名称已经存在！";


    //=================公司相关
    public static String COMPANY_NOT_EXIST = "该公司不存在！";

    public static String AGENT_USER_OWN_COMPANY_ERROR = "用户所属企业错误！";

    public static String COMPANY_DEPT_ERROR = "该公司部门错误！";

    public static String COMPANY_USER_DISABLE_SELECT_DEPT = "企业超级主用户不能更换部门！";


    //=================广告机相关
    public static String DEVICE_NOT_EXIST = "该广告机不存在！";


    //=================终端及终端类型管理

    public static String DEVICE_GROUP_NOT_MY = "不能操作非自己的终端类型！";

    public static String DEVICE_COMBO_NOT_EXIST = "该终端套餐不存在！";

    public static String DEVICE_SELECT_IS_ONLINE = "请选择在线终端";

    //================ 分辨率及分辨率类型管理

    public static String DPI_GROUP_NOT_MY = "不能操作非自己的分辨率类型！";


    //================== 素材 类型及 管理信息
    public static String RESOURCE_PARENT_NOT_EXIST = "素材资源父级不存在！";
    public static String RESOURCE_NOT_DEL_DEFAULT_DIR = "不能删除默认目录！";
    public static String FIRST_REMOVE_LOWER_RESOURCE_DIR = "请先删除下级记录！";
    public static String RESOURC_GROUP_NOT_EXIST = "素材类型分组不存在！";
    public static String RESOURCE_SIZE_NOT_ENOUGH = "磁盘空间大小不足";


    //=====================节目管理==============================
    public static String PROGRAM_GROP_HAS_DOWN_NOT_DEL = "该分组有节目，不能删除";


    // ===================模版商城管理================================

    public static String PROGRAM_TEMPLATE_MALL_NOT_EXIST = "该节目模版不存在";


    // =====================充值 付款====================================

    public static String RECHARGE_MONEY_NOT_ENOUGH = "充值金额不足！";


    //===================OSS 文件处理 ===================================

    public static String GET_OSS_RAM_ASS_FAIL = "获取OSS上传密钥失败！";
}
